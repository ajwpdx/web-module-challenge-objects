...
// function callFeedback(name, rev){
...
function getReviewByIndex(reviews, index) {
    return `${reviews[index].name} gave the restarant a ${reviews[index].rating} star review and their feedback was: ${reviews[index].feedback}`
  }
...
function getLastReview(reviews) {
    return `${reviews[reviews.length-1].name} gave the restarant a ${reviews[reviews.length-1].rating} star review and their feedback was: ${reviews[reviews.length-1].feedback}`
  } 
...
console.log(carMaker(100000).drive(500))
